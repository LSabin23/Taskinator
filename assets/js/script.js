...
var loadTasks = function () {
  ...
  // check if tasks is empty and assign it to an empty array then stop function
  if (!tasks) {
    tasks = []
    return false
  }

  // convert string tasks into tasks object array
  tasks = JSON.parse(tasks)

  // create task items on page from tasks array
